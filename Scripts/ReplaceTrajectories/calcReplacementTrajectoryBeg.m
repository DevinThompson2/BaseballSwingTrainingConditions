function [out,placementFrame] = calcReplacementTrajectory(missingMarker,aRef,bRef,cRef,sFrame)
    ...
    % available
    % Only use first few good frames to calculate distance (10)
    ...
    aCommonInterval = aCommonInterval(1:10);
    bCommonInterval = aCommonInterval(1:10);
    cCommonInterval = aCommonInterval(1:10);
