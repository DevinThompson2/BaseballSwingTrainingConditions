function [out,placementFrame] = calcReplacementTrajectory(missingMarker,aRef,bRef,cRef,sFrame)
    ...
    % available
    % Only use last few good frames to calculate the distance (10)
    ...
    aCommonInterval = aCommonInterval(end-10:end);
    bCommonInterval = aCommonInterval(end-10:end);
    cCommonInterval = aCommonInterval(end-10:end);
